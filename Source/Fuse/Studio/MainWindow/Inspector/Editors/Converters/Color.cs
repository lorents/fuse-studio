...
namespace Outracks.Fuse
{
	...
	{
		public static IProperty<Color> AsColor(this IProperty<string> property, Color defaultValue)
		{
			return property.Convert(str => TryParseColor(str).Value.Or(defaultValue), Serialize);
		}


		//public static IAttribute GetColor(this IElement element, string property, Color defaultValue)
		//{
