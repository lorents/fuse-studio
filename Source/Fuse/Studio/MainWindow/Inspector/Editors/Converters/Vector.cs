...
namespace Outracks.Fuse
{
	...
	{
		//public static IAttribute GetCorners(this IElement element, string property, Corners<Points> defaultValue)
		//{
		...
		//public static IAttribute GetThickness(this IElement element, string property, Thickness<Points> defaultValue)
		//{
		//	return element[property].Convert(
