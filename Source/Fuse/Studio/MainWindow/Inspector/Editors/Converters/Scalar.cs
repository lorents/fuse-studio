...
namespace Outracks.Fuse
{
	...
	{
		//public static IAttribute GetDouble(this IElement element, string property, double defaultValue)
		//{
		...
		//public static IAttribute GetInt(this IElement element, string property, int defaultValue)
		//{
		//	return element[property].Convert(
		//		parse: TryParseInt,
