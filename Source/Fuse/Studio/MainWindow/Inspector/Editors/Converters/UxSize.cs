...
namespace Outracks.Fuse
{
	...
	{
		//public static IAttribute GetSize2(this IElement element, string property, Size<UxSize> defaultValue)
		//{
		...
		//public static IAttribute GetSize(this IElement element, string property, UxSize defaultValue)
		//{
		//	return element[property].Convert(
		...
		//public static IAttribute GetPoints(this IElement element, string property, Points defaultValue)
		//{
		//	return element[property].Convert(
		...
		//public static IAttribute ToPoints(this IAttribute<double> property, double pointIncrement = 1.0)
		//{
