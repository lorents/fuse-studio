...
namespace Outracks.Fuse.Markup
{
	...
	class ElementTest
	{
		...
		//	var children = (await element.Children.FirstAsync()).ToImmutableList();
		...
		//	var root = (ElementEditor) CreateTree();
		...
		//{
		//	var parent = (ElementEditor) CreateTree();
		...
		//		await Element.Switch(parent.Children.Select(
